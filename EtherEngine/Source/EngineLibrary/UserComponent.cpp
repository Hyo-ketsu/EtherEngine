        ...
        for each (auto field in fields) {
            ...
            do {
                ...
                if (field->GetType() == int::typeid) {
                    ...
                    ImGuiFunction::ShowNumber<int>(number, ManageToUnmanage::String(field->Name));
                ...
                if (field->GetType() == uint::typeid) {
                    ...
                    ImGuiFunction::ShowNumber<uint>(number, ManageToUnmanage::String(field->Name));
                    field->SetValue(nullptr, number);
                    break;
                }
                // ullint
                if (field->GetType() == ullint::typeid) {
                    ...
                    ImGuiFunction::ShowNumber<ullint>(number, ManageToUnmanage::String(field->Name));
                    field->SetValue(nullptr, number);
                    break;
                }
                // float
                if (field->GetType() == float::typeid) {
                    ...
                    ImGuiFunction::ShowNumber<float>(number, ManageToUnmanage::String(field->Name));
                    field->SetValue(nullptr, number);
                    break;
                }
                // double
                if (field->GetType() == double::typeid) {
                    ...
                    ImGuiFunction::ShowNumber<double>(number, ManageToUnmanage::String(field->Name));
                    field->SetValue(nullptr, number);
                    break;
                }
                // string
                ...
                if (field->GetType() == System::String::typeid) {
                    auto str = ManageToUnmanage::String(safe_cast<System::String^>(field->GetValue(nullptr)));
                    ImGuiFunction::ImGuiShow<std::string>(str, ManageToUnmanage::String(field->Name));
                    field->SetValue(nullptr, UNMANAGE_TO_MANAGE_STRING(str));
                    break;
                }
                // Array
                // @ MEMO : 後回し
